...
mod tests {
    ...
    fn test_piece21_eat_piece54() {
        ...
        let can_choose_piece = actions_system
            .can_choose_piece(Position::Down, valid_piece_position54);
        assert(can_choose_piece, 'can_choose_piece failed');
        let current_piece: Piece = world.read_model((valid_piece_position54));
        ...
        let moved_piece: Piece = world.read_model((jump_position));
    ...
    fn test_move_king_piece() {
        ...
        let moving_piece = world.read_model((moving_cords));
        actions_system.move_piece(moving_piece, cheat_cords);

        let cheat_piece: Piece = world.read_model((cheat_cords));
        ...
        let moving_piece = world.read_model((actual_cords));
        actions_system.move_piece(moving_piece, moving_cords);
        let actual_piece: Piece = world.read_model((moving_cords));
        ...
        let actual_piece: Piece = world.read_model((new_cords));
